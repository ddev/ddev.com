...
3. The [procedurally-generated](https://github.com/ddev/ddev.com-front-end/blob/main/src/pages/resources/featured-sponsors.svg.js) featured sponsors [SVG](https://ddev.com/resources/featured-sponsors.svg) used in the [main project readme](https://github.com/ddev/ddev#wonderful-sponsors). It's darkmode equivalent gets created the same way but named featured-sponsors-darkmode.svg.js
