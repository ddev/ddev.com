...
export const GRAPHQL_ENDPOINT = 'http://ddevdotcom.ddev.site/wp/graphql';
export const GITHUB_REPO = 'drud/ddev';
export const GITHUB_URL = 'https://github.com/drud/ddev';
