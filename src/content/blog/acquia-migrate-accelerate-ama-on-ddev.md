...
## Overview
Migrating your Drupal 7 site may be easier than you thought with the help of [Acquia Accelerate: Migrate](https://www.drupal.org/project/acquia_migrate) (*AM:A as I'll refer to it from here forward*). 

From the project page of AM:A 
...
Drupal 9 is the only tested path at the time of this posting. [Drupal 9 was EoL on November 1st, 2023](https://www.drupal.org/psa-2023-11-01), and [Drupal 7 will be EoL on January 5th](https://www.drupal.org/psa-2023-06-07). The community can work together to make AM:A compatible with a direct to Drupal 10 migration path. Here's [the issue on drupal.org](https://www.drupal.org/project/acquia_migrate/issues/3399733) if you can help test this with D10. 

## Getting Started

Wim's [original walkthrough](https://dev.acquia.com/blog/acquia-migrate-accelerate-now-open-source) expects both D7 and the new D9 site to be on the same host. I found it simpler to keep this on a single DDEV instance rather than create multiple DDEV projects.
...
| Path Redirect     | yes       | no                | *D9 AM:A* migrated all Path Redirects flawlessly.<br><br>*D10 traditional* method did not, and also created hundreds of other redirects I did not want or need. |
| URL aliases       | yes       | no                | *D9 AM:A* migrated all URL Aliases flawlessly.<br><br>*D10 traditional* method migrated or created only 40 aliases that were not even part of my original D7 site, weird. |
| Text Formats      | yes       | yes               | *D9 AM:A* migrated all Text Formats, though advised me to delete PHP Filter, which I did.<br><br>*D10 traditional* migrated all of my text formats, but I was unable to get CKEditor 5 working properly. |
...
- Media system: I prefer to use the new Media system than the old basic Files system.
...
- Text Formats: AM:A migrated text formats, and nicely configured the WYSIWYG interface, the traditional method was a bit of a mess.

### Drawbacks of AM:A for my use case

These two drawbacks are worth the additional work it will take to re-create them. I look at is as an opportunity to improve. The Views and Pages I built were 10 years old, I welcome the opportunity to reevaluate and improve these within D9/D10.
...
I first wrote the following essay, which then inspired the full blog post. I hope it helps others like me who want to do Drupal again, but may be hesitant.
...
Looking back, my Drupal 7 site went from zero to a shaky 65% after a grueling 100 hours of traditional manual migration. But a spur-of-the-moment afternoon with AM:A? That changed everything. The site will be ready well before [Drupal 7's End of Life (EoL)](https://www.drupal.org/psa-2023-06-07). AM:A didn't just guide me through migration; it gave pre-migration advice, post-migration troubleshooting tips, and organized the content in a way that saved me from a lot of guesswork. Turns out, a little procrastination and the right tool can really pay off for anyone looking to upgrade their Drupal 7 site to D9/10. [Acquia Migrate: Accelerate](https://www.drupal.org/project/acquia_migrate) really smoothed out the bumps in the migration road for me.
