...
modifiedComment: "The billing/usage complaints in the Problems section below reflected the confusing state of things in September 2025. Anthropic has since made usage more visible (in-session usage indicators, separate weekly and 5-hour limits) — see [Claude's current plans](https://claude.com/pricing) for what's available today."
