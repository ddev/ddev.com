...
**Open-Source For The Win**: See the details about how a future incompatibility with the Docker engine was pre-emptively caught and fixed, [Open Source for the Win!](https://20250303-march-newsletter.ddev-com-front-end.pages.dev/blog/open-source-for-the-win/)

**Web-based DDEV Add-on Registry** is now live! Try it out [https://addons.ddev.com](https://addons.ddev.com)

**TYPO3 Community Budget Ideas: Please vote!**: We [applied for the Q2 approval process](https://talk.typo3.org/t/implement-mdns-for-ddev-name-resolution/6119/4) to fund a great feature for DDEV, supporting mDNS as a domain-name resolution technique. If you're a member of the TYPO3 Association, you've received an email to vote on this. We'd appreciate your vote!
...
- We applied for the [Google Summer of Code](https://summerofcode.withgoogle.com/) but did not get accepted.
